...
<title>Connecting to cloud server  </title></head>
</head>
	<style type="text/css"><!--
...
splashmessage[0]='Connecting to Cloud Server......'

splashmessage[1]='Please wait......'

splashmessage[2]='Please wait......'

splashmessage[3]='Your IP has limited access to server......'

splashmessage[4]='Please try again in a few minutes time!'
							...
							<tbody>
								<tr>
									...
									<table width="">
										<tbody>
											<tr>
												<td><img height="200" src="files/img4.gif" width="230" /></td>
												<td width="20"></td>
												<td width="350">
